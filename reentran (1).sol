...
contract EtherStore{  //lets say wemabank as name of cntract
    ...
    function withdraw() public {
     ...
     balances[msg.sender] = 0;//this single line of code secures your contract from being hacked,
     //by updating the sender balance equals to zero so no hack can take place
